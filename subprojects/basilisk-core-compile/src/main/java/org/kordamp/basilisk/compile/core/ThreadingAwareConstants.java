...
public interface ThreadingAwareConstants extends BaseConstants {
    String THREADING_HANDLER_TYPE = "basilisk.core.threading.ThreadingHandler";
    ...
    String METHOD_RUN_OUTSIDE_UITHREAD_ASYNC = "runOutsideUIAsync";
    ...
    MethodDescriptor[] METHODS = new MethodDescriptor[]{
        ...
        method(
            type(VOID),
            METHOD_RUN_OUTSIDE_UITHREAD_ASYNC,
            args(annotatedType(annotations(JAVAX_ANNOTATION_NONNULL), JAVA_LANG_RUNNABLE))
        ),
        annotatedMethod(
