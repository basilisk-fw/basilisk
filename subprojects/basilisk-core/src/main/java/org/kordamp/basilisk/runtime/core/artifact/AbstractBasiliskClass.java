...
import basilisk.util.BasiliskNameUtils;
...
import static basilisk.util.BasiliskNameUtils.getPropertyNameRepresentation;
...
import static org.kordamp.basilisk.runtime.core.artifact.ClassPropertyFetcher.forClass;

/**
 * Abstract base class for Basilisk types that provides common functionality for
 ...
 */
public abstract class AbstractBasiliskClass implements BasiliskClass {
    ...
    public AbstractBasiliskClass(@Nonnull BasiliskApplication application, @Nonnull Class<?> type, @Nonnull String artifactType, @Nonnull String trailingName) {
        ...
        packageName = BasiliskClassUtils.getPackageName(type);
        naturalName = BasiliskNameUtils.getNaturalName(type.getName());
        shortName = BasiliskClassUtils.getShortClassName(type);
        name = BasiliskNameUtils.getLogicalName(type, trailingName);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        BasiliskClass gc = (BasiliskClass) obj;
