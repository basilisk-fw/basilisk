 ...
 */
public class DefaultBasiliskModelClass extends DefaultBasiliskClass implements BasiliskModelClass {
    ...
    public DefaultBasiliskModelClass(@Nonnull BasiliskApplication application, @Nonnull Class<?> clazz) {
    ...
    public void setModelPropertyValue(@Nonnull BasiliskModel model, @Nonnull String propertyName, @Nullable Object value) {
        requireNonNull(model, ERROR_MODEL_NULL);
        requireNonBlank(propertyName, ERROR_PROPERTY_NAME_BLANK);
        BasiliskClassUtils.setPropertyValue(model, propertyName, value);
    }

    @Nullable
    public Object getModelPropertyValue(@Nonnull BasiliskModel model, @Nonnull String propertyName) {
        requireNonNull(model, ERROR_MODEL_NULL);
        requireNonBlank(propertyName, ERROR_PROPERTY_NAME_BLANK);
        return BasiliskClassUtils.getPropertyValue(model, propertyName);
    }
}
