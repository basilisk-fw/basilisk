 ...
 */
public class DefaultBasiliskControllerClass extends DefaultBasiliskClass implements BasiliskControllerClass {
    protected final Set<String> actionsCache = new TreeSet<>();

    public DefaultBasiliskControllerClass(@Nonnull BasiliskApplication application, @Nonnull Class<?> clazz) {
