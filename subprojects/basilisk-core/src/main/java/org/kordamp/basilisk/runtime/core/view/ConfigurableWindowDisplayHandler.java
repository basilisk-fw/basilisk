 ...
 */
package org.kordamp.basilisk.runtime.core.view;

import basilisk.core.BasiliskApplication;
import basilisk.core.CallableWithArgs;
import basilisk.core.RunnableWithArgs;
import basilisk.core.view.WindowDisplayHandler;
 ...
 * entry in <code>basilisk-app/conf/Config.groovy</code> that looks like the following one<p>
 * <pre>
 *     windowManager {
 *         myWindowName = [
 *             show: {name, window -> ... },
...
public class ConfigurableWindowDisplayHandler<W> implements WindowDisplayHandler<W> {
    ...
    @Inject
    public ConfigurableWindowDisplayHandler(@Nonnull BasiliskApplication application, @Nonnull @Named("defaultWindowDisplayHandler") WindowDisplayHandler<W> delegateWindowsDisplayHandler) {
