...
public class ClassPropertyFetcher {
            ...
            if (callback == null) {
                callback = new ReferenceInstanceCallback() {
                    ...
                    public Object getReferenceInstance() {
                        if (o == null) {
                            o = BasiliskClassUtils.instantiateClass(c);
                        }
                        return o;
                    }
                };
    ...
    private void init() {
                ...
                if (Modifier.isStatic(method.getModifiers())
                    ...
                    if (method.getParameterTypes().length == 0) {
                        ...
                        if (name.indexOf('$') == -1) {
                            ...
                            staticFetchers.put(BasiliskNameUtils.uncapitalize(name), fetcher);
                        }
                    }
                }
            }
        ...
        propertyDescriptors = BasiliskClassUtils.getPropertyDescriptors(clazz);
        ...
        for (Class<?> c : allClasses) {
            ...
            for (PropertyDescriptor p : BasiliskClassUtils.getPropertyDescriptors(clazz)) {
                props.add(p.getName());
            }
