...
public interface ActionInterceptor {
     ...
     */
    void configure(@Nonnull BasiliskController controller, @Nonnull String actionName, @Nonnull Method method);
     ...
     */
    @Nonnull
    Object[] before(@Nonnull BasiliskController controller, @Nonnull String actionName, @Nonnull Object[] args);
     ...
     */
    void after(@Nonnull ActionExecutionStatus status, @Nonnull BasiliskController controller, @Nonnull String actionName, @Nonnull Object[] args);
     ...
     */
    boolean exception(@Nonnull Exception exception, @Nonnull BasiliskController controller, @Nonnull String actionName, @Nonnull Object[] args);
}
