...
/**
 * Represents any class in a Basilisk application that is related to an artifact.</p>
 * While {@code BasiliskArtifact} points to the real artifact instance, this class points to the meta
 ...
 */
public interface BasiliskClass {
    Set<String> STANDARD_PROPERTIES = new TreeSet<>(
        Arrays.asList("class", "UIThread", "application", "basiliskClass", "log", "artifactType", "metaClass"));
    ...
    /**
     * Returns the actual class represented by the BasiliskClass</p>
     *
     * @return the class
     */
    @Nonnull
    ...
    /**
     * Returns the artifact type represented by the BasiliskClass</p>
     *
