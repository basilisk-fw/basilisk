...
/**
 * Represents a Controller class in Basilisk.<p>
 *
 * @author Andres Almiray
 */
public interface BasiliskControllerClass extends BasiliskClass {
    /**
     * "controller"
     */
     ...
     * <li>must pass {code BasiliskClassUtils.isPlainMethod()} if it's a method.</li>
