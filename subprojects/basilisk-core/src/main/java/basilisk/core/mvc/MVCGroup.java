...
public interface MVCGroup extends MVCHandler {
     ...
     *
     * @return a BasiliskModel instance if the group has a model member, null otherwise
     * @throws IllegalStateException if the group has been destroyed already
     */
    @Nullable
    BasiliskModel getModel();

    /**
     * Returns the View portion of this group.
     *
     * @return a BasiliskView instance if the group has a view member, null otherwise
     * @throws IllegalStateException if the group has been destroyed already
     */
    @Nullable
    BasiliskView getView();

    /**
     * Returns the Controller portion of this group.
     *
     * @return a BasiliskController instance if the group has a controller member, null otherwise
     * @throws IllegalStateException if the group has been destroyed already
     */
    @Nullable
