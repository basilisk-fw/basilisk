...
public interface AddonManager {
     ...
     */
    @Nonnull
    Map<String, BasiliskAddon> getAddons();

    /**
     * Finds an addon by name.<p>
     * Example: findAddon("miglayout") will return a BasiliskAddon that
     ...
     */
    @Nullable
    BasiliskAddon findAddon(@Nonnull String name);
}
