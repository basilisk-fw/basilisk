 ...
 * JDK!
 */
public class BasiliskNameUtils {
    ...
    /**
     * Retrieves the logical class name of a Basilisk artifact given the Basilisk class
     ...
     *     this.str = BasiliskNameUtils.requireNonBlank(str);
     * }
     * </pre></blockquote>
     *
     ...
     * <blockquote><pre>
     * public Foo(String str) {
     *     this.str = BasiliskNameUtils.requireNonBlank(str, "str must not be null");
     * }
     * </pre></blockquote>
     *
     * @param str     the String to check for blank
     ...
     * MyFunkyBasiliskThingy would be my-funky-basilisk-thingy.
     *
     ...
     * For example MyFunkyBasiliskThingy would be my-funky-basilisk-thingy.
     *
