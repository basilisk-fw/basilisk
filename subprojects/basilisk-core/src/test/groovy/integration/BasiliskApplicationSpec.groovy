...
class BasiliskApplicationSpec extends Specification {
    ...
    def 'Verify withMvcGroup(type, id, map , handler) (typed mvcgroup)'() {
        ...
        when:
        application.mvcGroupManager.withMVC(SimpleMVCGroup, 'simple-2', [key: 'basilisk'], new MVCFunction() {
            void apply(
                @Nullable BasiliskModel model, @Nullable BasiliskView view, @Nullable BasiliskController controller) {
                checks << (model instanceof SimpleModel)
                checks << (view instanceof SimpleView)
    ...
    def 'Verify withMvcGroup(type, map , handler) (typed mvcgroup)'() {
        ...
        when:
        application.mvcGroupManager.withMVC(SimpleMVCGroup, [key: 'basilisk'], new MVCFunction() {
            void apply(
                @Nullable BasiliskModel model, @Nullable BasiliskView view, @Nullable BasiliskController controller) {
                checks << (model instanceof SimpleModel)
                checks << (view instanceof SimpleView)
    ...
    def 'Verify createMVCGroup(type, map) (typed mvcgroup)'() {
        given:
        SimpleMVCGroup group = application.mvcGroupManager.createMVCGroup(SimpleMVCGroup, [key: 'basilisk'])
    ...
    def 'Verify createMVCGroup(type, id, map) (typed mvcgroup)'() {
        given:
        SimpleMVCGroup group = application.mvcGroupManager.createMVCGroup(SimpleMVCGroup, 'simple-2', [key: 'basilisk'])
    ...
    def 'Verify createMVC(type, map) (typed mvcgroup)'() {
        given:
        List members = application.mvcGroupManager.createMVC(SimpleMVCGroup, [key: 'basilisk'])
    ...
    def 'Verify createMVC(type, id, map) (typed mvcgroup)'() {
        given:
        List members = application.mvcGroupManager.createMVC(SimpleMVCGroup, 'simple-2', [key: 'basilisk'])
