...
import org.kordamp.basilisk.runtime.core.DefaultObservableContext
...
class ObservableContextSpec extends Specification {
    ...
    def "Exercise listener methods"() {
        ...
        then:
        ctx2.contextEventListeners == ([listener] as basilisk.core.ObservableContext.ContextEventListener[])
