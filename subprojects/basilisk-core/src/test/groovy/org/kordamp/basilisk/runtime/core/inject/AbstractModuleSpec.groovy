 ...
 */
package org.kordamp.basilisk.runtime.core.inject

import basilisk.core.injection.InstanceBinding
import basilisk.core.injection.Module
import basilisk.core.injection.ProviderBinding
import basilisk.core.injection.ProviderTypeBinding
import basilisk.core.injection.TargetBinding
...
class AbstractModuleSpec extends Specification {
    def "Verify all kinds of bindings"() {
        ...
        module.configure()
        List<basilisk.core.injection.Binding<?>> bindings = module.bindings
