...
class CompositeMessageSourceTests {
    ...
    void getAllMessagesByProperties() {
        MessageSource messageSource1 = new DefaultMessageSource(bundleBuilder, 'org.kordamp.basilisk.runtime.core.i18n.props')
        MessageSource messageSource2 = new DefaultMessageSource(bundleBuilder, 'org.kordamp.basilisk.runtime.core.i18n.props2')
