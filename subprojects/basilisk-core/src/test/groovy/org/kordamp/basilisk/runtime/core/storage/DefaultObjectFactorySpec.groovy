...
class DefaultObjectFactorySpec extends Specification {
    void "Find config under #key"() {
        ...
        def application = new DummyBasiliskApplication()
    ...
    private
    static class DummyBasiliskApplication extends TestBasiliskApplication {
...
class DefaultObjectFactory extends AbstractObjectFactory<String> {
    ...
    DefaultObjectFactory(
        ...
        @Nonnull BasiliskApplication application) {
