...
class CompositeResourceResolverTests {
    ...
    void resolveAllFormatsByProperties() {
        ResourceResolver resourceResolver1 = new DefaultResourceResolver(bundleBuilder, 'org.kordamp.basilisk.runtime.core.resources.props')
        ResourceResolver resourceResolver2 = new DefaultResourceResolver(bundleBuilder, 'org.kordamp.basilisk.runtime.core.resources.props2')
