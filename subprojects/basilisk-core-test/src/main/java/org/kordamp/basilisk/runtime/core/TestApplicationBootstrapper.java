...
import basilisk.core.injection.TestingModule;
import basilisk.core.test.TestCaseAware;
import basilisk.core.test.TestModuleAware;
import basilisk.core.test.TestModuleOverrides;
import basilisk.core.test.TestModules;
import basilisk.inject.BindTo;
import basilisk.util.AnnotationUtils;
import org.kordamp.basilisk.runtime.core.injection.AbstractTestingModule;
import org.kordamp.basilisk.runtime.core.injection.AnnotatedBindingBuilder;
import org.kordamp.basilisk.runtime.core.injection.LinkedBindingBuilder;
import org.kordamp.basilisk.runtime.core.injection.SingletonBindingBuilder;
...
public class TestApplicationBootstrapper extends DefaultApplicationBootstrapper implements TestCaseAware {
    ...
    public TestApplicationBootstrapper(@Nonnull BasiliskApplication application) {
        super(application);
    }
