...
class ObservableStreamSpec extends Specification {
    ...
    void "Check map/filter/reduce (default value) on #type"() {
        given:
        ObservableStream<Ghost> stream = BasiliskFXCollections.observableStream(ghosts)
    ...
    void "Check #method"() {
        given:
        ObservableStream<Ghost> stream = BasiliskFXCollections.observableStream(observableArrayList())
        Ghost value = CLYDE
