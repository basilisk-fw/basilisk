...
@Unroll
class BasiliskFXCollectionsSpec extends Specification {
    static {
    ...
    void "Trigger list events inside UI thread (source) "() {
        ...
        ObservableList<String> target = BasiliskFXCollections.uiThreadAwareObservableList(source)
    ...
    void "Trigger set events inside UI thread (source) "() {
        ...
        ObservableSet<String> target = BasiliskFXCollections.uiThreadAwareObservableSet(source)
    ...
    void "Trigger map events inside UI thread (source) "() {
        ...
        ObservableMap<String, String> target = BasiliskFXCollections.uiThreadAwareObservableMap(source)
