...
class UIThreadAwareBindingsSpec extends Specification {
    ...
    void "Verify update is triggered inside UI thread for #type"() {
        ...
        changeListener = UIThreadAwareBindings.uiThreadAwareChangeListener(changeListener)
        invalidationListener = UIThreadAwareBindings.uiThreadAwareInvalidationListener(invalidationListener)
        property.addListener(changeListener)
        property.addListener(invalidationListener)
