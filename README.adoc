...
image:https://ci.appveyor.com/api/projects/status/7e8hhrpu2p1avo76/branch/{github-branch}?svg=true[Build Status (appveyor)", link="https://ci.appveyor.com/project/aalmiray/basilisk/branch/{github-branch}"]
